    ...
    <main className="flex min-h-screen items-center justify-center bg-[var(--dg-ink)] px-4">
      <Card className="w-full max-w-sm p-8">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-xs text-[var(--dg-slate)]">Staff &amp; admin sign in</p>
        </div>
        {sp.error && (
        ...
        <form action={login} className="space-y-4">
          ...
          <Input label="Email" name="email" type="email" required placeholder="you@districtgym.com" />
        ...
        <p className="mt-6 text-center text-xs text-[var(--dg-slate)]">
          Member?{" "}
          <Link href="/member-login" className="font-medium text-[var(--dg-accent)]">
